...
disp(['fastscatterRAD x-axis variable is ' xaxis_variable '.']);
...
figure(1 + figure0)
fastscatterRAD(xVariable, Pr, Vel(:, :, 1), mrkr, 'markersize',  mrkrSize);
axis ij
...
figure(2 + figure0)
fastscatterRAD(xVariable, Pr, Amp(:, :, 1), mrkr, 'markersize',  mrkrSize);
axis ij
...
if all(isnan(Cor(:)))
    ...
    fastscatterRAD(xVariable, Pr, Cor(:, :, 1), mrkr, 'markersize',  mrkrSize);
    axis ij
...
figure(4 + figure0)
fastscatterRAD(xVariable, Pr, Vel(:, :, 2), mrkr, 'markersize',  mrkrSize);
axis ij
...
figure(5 + figure0)
fastscatterRAD(xVariable, Pr, Amp(:, :, 2), mrkr, 'markersize',  mrkrSize);
axis ij
...
if all(isnan(Cor(:)))
    ...
    fastscatterRAD(xVariable, Pr, Cor(:, :, 2), mrkr, 'markersize',  mrkrSize);
    axis ij
...
figure(7 + figure0)
fastscatterRAD(xVariable, Pr, Vel(:, :, 3), mrkr, 'markersize',  mrkrSize);
axis ij
...
figure(8 + figure0)
fastscatterRAD(xVariable, Pr, Amp(:, :, 3), mrkr, 'markersize',  mrkrSize);
axis ij
...
if all(isnan(Cor(:)))
    ...
    fastscatterRAD(xVariable, Pr, Cor(:, :, 3), mrkr, 'markersize',  mrkrSize);
    axis ij
