...
%..                        removed nan padding before doing check in function maxabsdev
%=========================================================================
precision = '%.8f';
...
%.. in two datasets
%
%.. in structure MMP, L1 profiles are nan-padded to fit into one 2D array; 
%.. when different numbers of profiles are processed, in general there can
%.. be a difference in the number of padding nans. remove them before comparing.
data1(isnan(data1)) = [];
data2(isnan(data2)) = [];
