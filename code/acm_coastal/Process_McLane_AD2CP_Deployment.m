...
% radMMP version 4.0
% RADesiderio, Oregon State University, 2021-05-24
%=========================================================================
% DESCRIPTION
...
%
%    Process_OOI_McLane_CTDENG_Deployment.m must be run first so that its
%    processed CTD data can be used to add a CTD pressure record to the
%    AD2CP acoustic currentmeter data.
%
%    This code specifically processes OOI data
...
%       INPUT:
%          mode = 'import' 
%          mmp_matfilename must come from the 2nd output argument from a run of Process_OOI_McLane_CTDENG_Deployment and contain
