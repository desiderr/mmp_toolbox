function [aqd] = aqd_wag_velocity(aqd)
%=========================================================================
% DESCRIPTION
%   Calculates the wag correction velocity.
%
% USAGE:  [aqd] = aqd_wag_velocity(aqd)
%
%   INPUT
...
%   case basis can do a very good job of cancelling out wag artifacts.
%
% AUTHOR
...
%.. 2021-04-20: desiderio: renamed from aqd_wag_correction to aqd_wag_velocity
