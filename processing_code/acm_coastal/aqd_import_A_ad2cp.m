...
function [aqd] = aqd_import_A_ad2cp(filename)
%=========================================================================
% DESCRIPTION:
%    Imports Nortek AD2CP data from unpacked McLane profiler 'A' files.
%
% USAGE:  aqd = aqd_import_A_ad2cp(filename)
%
%   INPUT
...
%.. 2021-04-19: desiderio: 
%..            (a) renamed this function by prepending 'aqd_'; now all
%..                functions requiring only aqd data input have names
%..                starting with 'aqd_'.
%..            (b) initialization of sensor_field_indices corrected to 7:25
%..                for compatibility with void_short_profiles.m
%.. 2021-04-29: desiderio: updated documentation
%.. 2021-05-08: desiderio
%..             (a) added profile_date (init as nan) and backtrack fields
%..             (b) adjusted sensor_field_indices vector
%..             (c) s_f_i no longer includes imported_data field
...
aqd.sensor_field_indices = [10:27];  %#ok 
...
aqd.depth_offset_m       = 0;   % overwritten with metadata value
aqd.on                   = '';
aqd.off                  = '';
