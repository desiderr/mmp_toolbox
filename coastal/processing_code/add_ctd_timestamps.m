...
%.. 2021-05-03: desiderio: trapped out eng.time = [] case.
...
%.. the only change from the original ver 2.00 (2019-07-16) is that
%.. the following lines are commented out so that backtrack processing
%.. options are enabled (previously all backtrack code settings behaved
%.. as intended for code = 1).
%***********************************************************************
%       ctd.time = nan(size(ctd.pressure));
%       ctd.data_status(end+1) = {'NaN TIMESTAMPS ADDED'};
%       return
