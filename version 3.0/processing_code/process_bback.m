...
%   data product) from OOI_L1 eco triplet or flbbrtd backscatter data 
%
...
theta  = meta.fluorometer_cal.bback_scattering_angle;
lambda = meta.fluorometer_cal.bback_wavelength;
chi    = meta.fluorometer_cal.bback_chi_factor;
